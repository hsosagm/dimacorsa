<div id="gastos" style="padding-right: 40px">
    <form v-on="submit: submit" class="form-horizontal" id="gastosForm">
        <div class="form-group" style="padding-bottom: 20px">
            ...
            <div class="col-sm-3">
                {{ Form::select('categoria_id', categoriasGasto::lists('nombre', 'id') ,'', array('class'=>'form-control', 'v-model'=>'categoria')) }}
            </div>
            <div class="col-sm-1"> </div>
            <label class="col-sm-2" for="email">Subcategoria:</label>
            <div class="col-sm-3">
                {{ Form::select('subcategoria_id', subcategoriasGasto::lists('nombre', 'id') ,'', array('class'=>'form-control', 'v-model'=>'subcategoria')) }}
            </div>
        </div>
    ...
    methods: {
        ...
        submit: function(e)
        {
            ...
            $.ajax({
                ...
                data: { categoria_id: this.categoria, subcategoria_id: this.subcategoria, detalle: this.detalle },
            }).done(function(data) {
                if (!data.success) {
