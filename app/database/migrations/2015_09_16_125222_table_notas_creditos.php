...
class TableNotasCreditos extends Migration {
	public function up()
	{
		...
		Schema::create('adelanto_nota_credito', function(Blueprint $table)
		{
			$table->increments('id');
		...
		Schema::create('devolucion_nota_credito', function(Blueprint $table)
		{
			$table->increments('id');
			$table->integer('nota_credito_id')->unsigned();
		...
		Schema::create('detalle_devolucion_nota_credito', function(Blueprint $table)
		{
			$table->increments('id');
			...
			$table->timestamps();
			$table->foreign('devolucion_id')->references('id')->on('devolucion_nota_credito')->onDelete('cascade')->onUpdate('cascade');
	...
	{
		Schema::drop('detalle_devolucion_nota_credito');
		Schema::drop('devolucion_nota_credito');
		Schema::drop('adelanto_nota_credito');
