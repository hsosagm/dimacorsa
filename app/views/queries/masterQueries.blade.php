    ...
    <table id="MasterQueries" v-if="showMaster" style="text-align:center">
        ...
        <tr>
            ...
            <td><p>Notas de Credito</p><img src="images/consultas/anticipos.png" height=80 width=80></img>
                 <div class="row">
                    <div class="col-md-5 center" v-on="click: getConsultasPorFecha('dia', 'NotasDeCredito')"><span>Hoy</span></div>
                    <div class="col-md-2 center"><span>|</span></div>
                    <div class="col-md-5 center" v-on="click: getConsultasPorFecha('mes', 'NotasDeCredito')"><span>Fecha</span></div>
                </div>
            </td>
