        ...
        $('#example').dataTable({
            ...
            "aoColumnDefs": [
                ...
                {"sClass": "widthS icons center",                          "sTitle": "",            "aTargets": [5],
                    "orderable": false,
                    "mRender": function() {
                        return ' <i class="fa fa-trash-o btn-link theme-c" title="Eliminar"  url="user/ingresos/" onclick="_delete_dt(this)"></i> ';
                    }
                },
            ],
            "order": [[ 1, "desc" ]],
            ...
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "admin/queries/DtIngresosPorFecha/{{$consulta}}",
