    ...
    <div class="panel-body-cierre no-padding" id="table " style="border-bottom: double;">
		<table width="100%" id="table table-responsive">
			...
			<tbody class="table-hover cierre_body" style="border-bottom: double;">
				...
				<tr>
					<td>Adelantos</td>
					<td align="right" class="right hover" onclick="asignarInfoEnviar('Adelantos',1);">
					   {{ f_num::get($data['adelantos']['efectivo'])}} 
					</td> 
					<td align="right" class="right      "> 
						{{ f_num::get($data['adelantos']['credito'] )}} 
					</td> 
					<td align="right" class="right hover" onclick="asignarInfoEnviar('Adelantos',3);">
					   {{ f_num::get($data['adelantos']['cheque']  )}} 
					</td> 
					<td align="right" class="right hover" onclick="asignarInfoEnviar('Adelantos',4);">
					   {{ f_num::get($data['adelantos']['tarjeta'] )}} 
					</td> 
					<td align="right" class="right hover" onclick="asignarInfoEnviar('Adelantos',5);">
					   {{ f_num::get($data['adelantos']['deposito'])}} 
					</td> 
					<td align="right" class="right      "> {{ f_num::get($data['adelantos']['total'])   }} </td> 
				</tr>
				<tr>
					<td>Ingresos</td>
