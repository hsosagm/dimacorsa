		...
		<table width="100%" id="table table-responsive">
			...
			<tbody class="table-hover cierre_body" style="border-bottom: 1px solid;">
                ...
                <tr>
	                ...
	                <td align="right" class="right hover" v-on="click: getAsignarInfoEnviar('AdelantosNotasCreditos', 1);">
	                    {{ f_num::get($data['adelanto_notas_creditos']['efectivo']) }}
	                </td>
	                <td align="right" class="right">
	                    {{ f_num::get($data['adelanto_notas_creditos']['credito']) }}
	                </td>
	                <td align="right" class="right hover" v-on="click: getAsignarInfoEnviar('AdelantosNotasCreditos', 3);">
	                    {{ f_num::get($data['adelanto_notas_creditos']['cheque']) }}
	                </td>
	                <td align="right" class="right hover" v-on="click: getAsignarInfoEnviar('AdelantosNotasCreditos', 4);">
	                    {{ f_num::get($data['adelanto_notas_creditos']['tarjeta']) }}
	                </td>
	                <td align="right" class="right hover" v-on="click: getAsignarInfoEnviar('AdelantosNotasCreditos', 5);">
	                    {{ f_num::get($data['adelanto_notas_creditos']['deposito']) }}
	                </td>
	                <td align="right" class="right"> {{ f_num::get($data['adelanto_notas_creditos']['total']) }} </td>
	            </tr>
				<tr>
					<td>Ingresos</td>
                ...
                <tr>
	                ...
	                <td align="right" class="right hover" v-on="click: getAsignarInfoEnviar('DevolucionNotasCreditos', 1);">
					...
					<td align="right" class="right hover" v-on="click: getAsignarInfoEnviar('DevolucionNotasCreditos', 3);">
	                    {{ f_num::get($data['devolucion_notas_creditos']['cheque']) }}
	                </td>
	                <td align="right" class="right">
	                    {{ f_num::get($data['devolucion_notas_creditos']['tarjeta']) }}
	                </td>
	                <td align="right" class="right hover" v-on="click: getAsignarInfoEnviar('DevolucionNotasCreditos', 5);">
	                    {{ f_num::get($data['devolucion_notas_creditos']['deposito']) }}
	                </td>
	                <td align="right" class="right"> {{ f_num::get($data['devolucion_notas_creditos']['total']) }} </td>
	            </tr>
				<tr>
					<td>Pagos Compras</td>
