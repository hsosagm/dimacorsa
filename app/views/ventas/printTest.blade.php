...
<!-- Page styling -->
<script type="text/javascript" src="js/qz/jquery-1.11.3.min.js"></script>
<script type="text/javascript" src="js/qz/bootstrap.min.js"></script>
<link rel="stylesheet" href="js/qz/font-awesome.min.css" />
<link rel="stylesheet" href="js/qz/bootstrap.min.css" />
<link rel="stylesheet" href="js/qz/style.css" />
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-inline">
                                            <label for="serialStart">Response Start</label>
                            ...
                            <div class="btn-toolbar">
                                ...
                                <div class="btn-group" data-toggle="buttons">
                                    <label id="usbRawRadio" class="btn btn-default active">
                                        <input type="radio" autocomplete="off" checked>Raw
                                    </label>
                                    <label id="usbWeightRadio" class="btn btn-default">
                                        <input type="radio" autocomplete="off">Weight
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-inline">
                                            <label for="hidStream" class="tip" data-toggle="tooltip" title="in milliseconds">Stream Interval</label>
