<html>
    <div style="display: block; padding: 15px; padding-bottom: 35px; width:450px; ">
        <table width="100%" style="font-weight: 100 !important; font-size:9pt; font-face:\'Courier New\';">
            <tr>
                <td>
            ...
            <tr>
                <td align="left">
                    <table style="font-weight: 100 !important; font-size:9pt; font-face:\'Courier New\';">
                        <tr>
                            <td colspan="2"> 3ra calle 13-71 zona 1, Chiquimula   Telefono: 7942-1383</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>  Garantia No. : {{ @$venta->id }} </td>
                            <td> {{ @$venta->cliente->direccion.' ' }} {{ ' '.@$venta->cliente->nit }} </td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table width="100%" class="table" style="font-weight: 100 !important; font-size:9pt; font-face:\'Courier New\';">
            <tr>
            ...
            <tr>
                ...
                <td width="50%">  {{ $dt->producto->descripcion}} </td>
                <td width="15%" align="right"> {{ f_num::get($dt->precio) }} </td>
                <td width="15%" align="right"> {{ f_num::get($dt->cantidad * $dt->precio)}} </td>   
                <th width="5%"> </th>
            </tr>
            <?php 
            ...
            <tr>
                ...
                <td align="right"> Q {{f_num::get($total)}} </td>
                <th width="5%"> </th>
            ...
            <tr>
                <td align="justify" colspan="4" style="font-weight: 100 !important; font-size:7pt; font-face:\'Courier New\';">
