        ...
        "aoColumnDefs": [
            ...
            {"sClass": "widthS icons center", "orderable": false,             "sTitle": "",        "aTargets": [7],
                "mRender": function(  data, type, full ) {
                    ...
                    $v += '<a href="javascript:void(0);" title="Imprimir Factura" onclick="printInvoice(this, '+full.DT_RowId+', '+"'"+'{{@$factura->impresora}}'+"'"+')" class="fa fa-print font14" style="padding-left:10px">';
                    $v += '<a href="javascript:void(0);" title="Imprimir Garantia" onclick="ImprimirGarantia(this, '+full.DT_RowId+', '+"'"+'{{@$garantia->impresora}}'+"'"+')" class="fa fa-file-o font14" style="padding-left:10px">';
