<li class="submenu">
	...
	<ul>
		...
		{{-- <li> <a href="javascript:void(0)" onclick="getActualizarPagosCompraFinalizada(this, 2928);"><i class="fa fa-exchange"></i>prueba</a> </li> --}}
		{{-- <li> <a href="javascript:void(0)" onclick="getActualizarPagosCompraFinalizada(this, 27142)"><i class="fa fa-exchange"></i>prueba</a> </li> --}}
	</ul>
</li>
