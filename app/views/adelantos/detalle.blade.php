...
<div class="form-footer" >
	<div class="row">
		<div class="col-md-6">
			<i class="fa fa-file-pdf-o fa-lg icon-print" onclick="ImprimirAdelanto(this, {{$cotizacion_id}});"></i>
		</div>
		<div class="col-md-6" align="right">
			<i class="fa fa-trash-o fa-lg icon-delete" onclick="EliminarAdelanto(this, {{$cotizacion_id}});"></i>
		</div>
	</div>
</div>
</div>
