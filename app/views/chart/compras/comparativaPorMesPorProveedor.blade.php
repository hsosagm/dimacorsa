<script type="text/javascript">
    ...
    var datos  =  {{$data}};
    var proveedor_id = {{ Input::get('proveedor_id') }};
    ...
    $(function () {
        ...
        $('#container').highcharts({
            ...
            plotOptions: {
                ...
                series: {
                    ...
                    dataLabels: {
                        ...
                        formatter: function() {
                            if(this.series.name == 'Compras por dia') {
                                var num = this.y / 1000;
            ...
            tooltip: {
                ...
                formatter: function() {
                    return '<div class="toltip">Total compras de'+' '+this.point.name+'</div><i>'+'Q'+' '+Highcharts.numberFormat(this.y, 2)+'</i>';
                }
            },
                ...
                buttons: {
                    ...
                    'next': {
                        ...
                        onclick: function() {
                            $.ajax({
                                type: "GET",
                                url: 'admin/chart/comparativaPorMesPorProveedorPrevOrNext',
                                data: { mes: mes, proveedor_id: proveedor_id, method: "next" },
                            }).done(function(data) {
                                if (data.success == true)
                                {
                                    ...
                                    chart.series[0].setData(data.compras);
                                    return;
                                }
                    ...
                    'prev': {
                        ...
                        onclick: function() {
                            $.ajax({
                                type: "GET",
                                url: 'admin/chart/comparativaPorMesPorProveedorPrevOrNext',
                                data: { mes: mes, proveedor_id: proveedor_id, method: "prev" },
                            }).done(function(data) {
                                if (data.success == true)
                                {
                                    if (mes == 1) {
