	...
	<table width="100%">
		...
		<tfoot width="100%">
			<tr>
			    <td>
					<div class="row">
						<div class="col-md-8" >  Total Cotizacion </div>
						<div class="col-md-4" v-html="totalCotizacion | currency ''" class="td_total_text" style="text-align:right; padding-right:50px;"></div>
					</div>
			    </td>
		    </tr>
		</tfoot>
