{{ Form::open(array('url'=>'/user/cotizaciones/ingresarProductoRapido', 'data-remote-md-d', 'data-success'=>'Producto Ingresado', 'status'=>'0')) }}
    <div class="row">
        <div class="col-md-6">
            <div class="col-md-6">
            ...
            <div class="col-md-12"style="margin-top:5px; text-align:right;">
                <button type="button" name="button" class="bg-theme" onclick="ingresarProductoAlDetalle(this)">Guardar..!</button>
            </div>
        </div>
    </div>
{{ Form::close() }}
